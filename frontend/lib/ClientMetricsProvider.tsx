...
/**
 * Client Metrics Context for UI Interaction Tracking
 * 
 * Provides a centralized way to track user interactions and system metrics
 * throughout the weather forecasting frontend application using browser-compatible metrics.
 */
...
export const useMetrics = () => {
  ...
  if (!context) {
    throw new Error('useMetrics must be used within a ClientMetricsProvider');
  }
  return context;
};

interface ClientMetricsProviderProps {
  children: React.ReactNode;
}

export const ClientMetricsProvider: React.FC<ClientMetricsProviderProps> = ({
  children
}) => {
