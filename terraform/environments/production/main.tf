# Production Environment Infrastructure for Adelaide Weather Forecast
terraform {
...
# VPC Module with Multi-AZ for Production
module "vpc" {
...
module "eks" {
  ...
  # Cluster addons with specific versions for stability
  cluster_addons = {
    coredns = {
      most_recent = true
...
resource "aws_iam_policy" "aws_load_balancer_controller" {
  name = "${local.name_prefix}-AWSLoadBalancerControllerPolicy"
...
# RDS Multi-AZ Instance for Production
...
resource "aws_db_instance" "main" {
  ...
  # Production-grade backup and maintenance
...
resource "aws_elasticache_replication_group" "main" {
  ...
  description                = "Redis cluster for Adelaide Weather Forecast production"
...
# CloudWatch Log Groups with longer retention
